...
module.exports = {
    ...
    onStart: async function({ api, event, args }) {
        ...
        if (!input) return api.sendMessage(formatResponse("【⚚⊰𝘼𝗻𝗴𝗲𝗹𝗼 𝗗𝗲𝘅𝘁𝗲𝘂𝗿 𝘼𝙄⊱】–シ\n━━━━━━━━━━━━━━━\n 𝐒𝐚𝐥𝐮𝐭 👋 𝐥'𝐚𝐦𝐢 (𝐞) 𝐦𝐨𝐢 𝐜'𝐞𝐬𝐭【⚚⊰𝘼𝗻𝗴𝗲𝗹𝗼 𝗗𝗲𝘅𝘁𝗲𝘂𝗿 𝘼𝙄⊱】–シ, 𝐪𝐮𝐞𝐥𝐥𝐞 𝐞𝐬𝐭 𝐯𝐨𝐭𝐫𝐞 𝐪𝐮𝐞𝐬𝐭𝐢𝐨𝐧 𝐝𝐮 𝐣𝐨𝐮𝐫..?\n━━━━━━━━━━━━━━━\n【⚚⊰𝘼𝗻𝗴𝗲𝗹𝗼 𝗗𝗲𝘅𝘁𝗲𝘂𝗿 𝘼𝙄⊱】–シ"), event.threadID);
